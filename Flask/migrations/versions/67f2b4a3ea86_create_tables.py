...
Revision ID: 67f2b4a3ea86
Revises: 
Create Date: 2020-05-24 00:24:11.393983
...
def downgrade():
    ...
    sa.Column('warning', mysql.TEXT(collation='utf8_unicode_ci'), nullable=True),
    sa.Column('website', mysql.TEXT(collation='utf8_unicode_ci'), nullable=True),
    sa.Column('token', mysql.TEXT(collation='utf8_unicode_ci'), nullable=True),
